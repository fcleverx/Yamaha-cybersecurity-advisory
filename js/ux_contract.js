...
App.UXContract = (() => {
  ...
  const MAJOR_PAGES = [
    ...
    { id: 'preview', label: 'Preview', href: 'preview.html' },
  ...
  function injectStyles() {
    ...
    style.textContent = `
      ...
      .ux-menu-link.active {
        border-color: rgba(38,39,224,.8);
        color: #2627e0;
        background: rgba(38,39,224,.1);
      }
      .ux-flow {
        display: flex;
        align-items: center;
      ...
      .ux-guard p { margin: 0; color: #000000; line-height: 1.5; }
      ...
      .ux-state-card.loading {
        border-color: rgba(38,39,224,.45);
        background: rgba(38,39,224,.08);
      }
      .ux-state-card h3 { margin: 0 0 .25rem; font-size: .85rem; }
      .ux-state-card p { margin: 0; font-size: .78rem; color: #000000; }
