...
- `baseline-critical-path-audit.md` previously recorded `CP-01` and `CP-02` as blocked because live feed fetching produced no usable article set.
...
- `foundation_ux_contract.md` defines the active flow as `Fetch -> Curate -> Build -> Edit -> Approve -> Send`.
